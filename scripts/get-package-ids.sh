...
DAR=($(daml damlc inspect .lib/daml-finance-instrument-swap-0.1.5.dar | head -1))
echo \"@daml.js/daml-finance-instrument-swap\": \"file:daml.js/${DAR[1]}\",
...
DAR=($(daml damlc inspect .lib/daml-finance-interface-instrument-bond-0.1.4.dar | head -1))
...
DAR=($(daml damlc inspect .lib/daml-finance-interface-instrument-swap-0.1.4.dar | head -1))
echo \"@daml.js/daml-finance-interface-instrument-swap\": \"file:daml.js/${DAR[1]}\",

DAR=($(daml damlc inspect .lib/daml-finance-interface-instrument-token-0.1.4.dar | head -1))
