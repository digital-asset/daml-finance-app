...
import { Service, Request, Offer } from "@daml.js/daml-finance-app/lib/Daml/Finance/App/Listing/Service"
import useStyles from "../styles";
import { getName, getTemplateId } from "../../util";
import { InputDialog, InputDialogProps } from "../../components/InputDialog/InputDialog";
import { VerifiedIdentity } from "@daml.js/daml-finance-app/lib/Daml/Finance/App/Regulator/Model";
import { Role } from "@daml.js/daml-finance-app/lib/Daml/Finance/App/Trading/Role";
...
export const Listing : React.FC = () => {
  ...
  const offerService = () => {
    const onClose = async (state : any | null) => {
      ...
      await ledger.exercise(Role.OfferListingService, roles[0].contractId, { customer: identity.payload.customer });
    };
  ...
  const approveRequest = async (c : CreateEvent<Request>) => {
    ...
    await ledger.exercise(Role.ApproveListingServiceRequest, roles[0].contractId, { listingRequestCid: c.contractId });
  }
