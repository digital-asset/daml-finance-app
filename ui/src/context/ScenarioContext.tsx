...
const distribution  = { name: "Distribution", path: "distribution", elem: <App key={5}  label="Distribution"  description="Distribute assets in the primary market" image={appDistribution} path="/app/distribution/pedistributions" /> };
