...
import { Service as Investment } from "@daml.js/daml-finance-app-interface-distribution/lib/Daml/Finance/App/Interface/Distribution/Investment/Service";
...
export const New : React.FC = () => {
  ...
  const myServices = investment.services.filter(s => s.payload.customer === party);
  ...
  if (!svc) return <Message text={"No investment service found for customer: " + party} />;
  ...
  const requestInvestment = async () => {
    ...
    await ledger.exercise(Investment.RequestInvestment, svc.service.contractId, arg);
